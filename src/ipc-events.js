const IpcEvents = exports.IpcEvents = {
    ...
    INTERACTION_NOTIFICATION: 'INTERACTION_NOTIFICATION'
}

const ipcMainEvents = exports.ipcMainEvents = [
    ...
    IpcEvents.TASK_DONE,
    IpcEvents.INTERACTION_NOTIFICATION
  ];

const ipcRendererEvents = exports.ipcRendererEvents = [
  ...
  const WEBCONTENTS_READY_FOR_IPC_SIGNAL = exports.WEBCONTENTS_READY_FOR_IPC_SIGNAL = 'WEBCONTENTS_READY_FOR_IPC_SIGNAL';